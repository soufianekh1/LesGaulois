...
public class Druide {
	...
	public void parler(String texte) {
		System.out.println("Bonjour , je suis le druide " + nom + " et ma potion peut aller  d'une force "
	...
	public int preparerPotion() {
		...
		if (forcePotion > 7) {
			...
			System.out.println(
					"Je n'ai pas trouvé tous les ingrédiants, ma potion est seulement de force " + forcePotion);
		}
		return forcePotion;
	}
